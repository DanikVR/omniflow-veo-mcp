...
- **No dependencies, on purpose.** The bridge runs on Node 20 built-ins only so `npx -y github:DanikVR/omniflow-veo-mcp` starts instantly on any machine. Please keep it that way.
